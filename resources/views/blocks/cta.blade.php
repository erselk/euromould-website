...
<section class="py-16 md:py-24 bg-primary relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <a href="{{ url($data['button_url'] ?? '/iletisim') }}" class="inline-block bg-white text-primary px-8 py-3 md:px-10 md:py-4 font-bold uppercase tracking-widest hover:bg-slate-900 hover:text-white transition-all duration-300 shadow-xl rounded-sm text-sm md:text-base">
