...
<head>
    ...
    <meta property="og:image" content="{{ asset('images/logo.png') . "?v=5" }}">
    ...
    <meta name="twitter:image" content="{{ asset('images/logo.png') . "?v=5" }}">
    ...
    <script type="application/ld+json">
    {
      ...
      "logo": "{{ asset('images/logo.png') . "?v=5" }}",
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <a href="{{ localized_url('/') }}" class="flex items-center gap-3">
                             @if(isset($settings) && $settings->logo)
                                <img class="h-12 w-auto" width="1856" height="438" src="{{ asset($settings->logo) . "?v=5" }}" alt="EuroMould">
                            @else
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 md:gap-y-12 mb-16">
                ...
                <div class="col-span-2 md:col-span-2 lg:col-span-1 flex flex-col items-center md:items-start lg:items-center text-center md:text-left">
                     <div class="mb-6">
                         <img class="h-24 w-auto" width="897" height="696" src="{{ asset('images/logo.webp') . "?v=5" }}" alt="EuroMould">
                     </div>
