    ...
    <section class="bg-slate-900 text-white py-24 md:py-32 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-4xl">
                ...
                <h1 class="text-4xl md:text-6xl font-black tracking-tight mb-4">{!! nl2br(e($service->title)) !!}</h1>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row gap-16">
                <!-- Main Content -->
                <div class="lg:w-2/3">
                    <div class="prose prose-lg prose-slate max-w-none prose-headings:font-bold prose-headings:text-slate-900 prose-a:text-primary">
                ...
                <div class="lg:w-1/3 space-y-8">
                    ...
                    <div class="bg-slate-50 p-8 rounded-none border border-slate-100">
                    ...
                    <!-- CTA Widget -->
                    <div class="bg-primary text-white p-8 rounded-none">
                        <h3 class="text-xl font-bold mb-4">Bu hizmetle ilgileniyor musunuz?</h3>
                        <p class="mb-6 opacity-90">Projeleriniz için özel çözümler ve fiyat teklifi almak için bizimle iletişime geçin.</p>
                        <a href="{{ url('/iletisim') }}" class="inline-block w-full text-center py-3 bg-white text-primary font-bold hover:bg-slate-100 transition-colors">
                            Teklif Alın
                        </a>
                    </div>
                </div>
